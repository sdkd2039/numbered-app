    ...
    companion object {
        ...
        private fun updateOne(
            ...
            if (event == null) {
                 ...
                 *
                 * من المناسبة السابقة إلى المناسبة الحالية.
                 */
                val previousEvent =
            ...
            /*
             * تطبيق الخط المخصص على نصوص Widget المتبقي.
             */
            applyFont(
                views,
                R.id.remaining_event_name
...
private object RemainingEventSchedule {
    ...
    fun previousEvent(
        ...
        confirmedEvents
            .filter {
                it.gregorianMillis < eventMillis
            }
            .maxByOrNull {
                it.gregorianMillis
            }
